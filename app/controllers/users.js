...
const debug = require('debug')('bucket-list-api:users');
...
const signup = (req, res, next) => {
  ...
  let user = { userName: credentials.userName, yearOfBirth: credentials.yearOfBirth, password: credentials.password };
  getToken().then(token =>
    user.token = token
  ).then(() =>
    new User(user).save()
